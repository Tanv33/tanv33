...
```ts
const tanveer = {
  building: ["Solana programs", "high-throughput APIs", "TypeScript SDKs"],
  daily:    ["Rust", "TypeScript", "Node.js", "PostgreSQL", "Docker"],
  learning: "Kubernetes",
  askMeAbout: ["Anchor", "PDAs & CPIs", "scaling Node", "queue design"],
  funFact:   "I find the edge case before it finds production.",
};
```
...
| Project | What I did |
| --- | --- |
| [**Backend-Template**](https://github.com/Tanv33/Backend-Template) `⭐ 38` | Node.js starter with a structure that survives month six |
...
Looking for **Solana Engineer**, **Backend Engineer**, or **Full-stack** roles.

- 🌍 Remote, hybrid, on-site, or relocation (on-site outside Pakistan needs visa sponsorship)
- 🕐 Based PKT (UTC+5), comfortable overlapping US or EU hours
